...
**Örnek:**
\`\`\`${Prefix}Trol-ver ${message.guild.roles.cache.random().id}\`\`\``).setColor('#9c5cb2'));
...
.setTitle('İşte bu kadar!').setDescription(`**Sunucunuzda ki üyeler'e yavaş yavaş ${message.guild.roles.cache.get(args[0])} adlı rol veriliyor.**`));
