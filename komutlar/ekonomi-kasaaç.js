...
exports.run = async (client, message, args) => {
  ...
  while (!uwu) {
    ...
    if (choice !== 'evet' && choice !== 'e') {
      message.channel.send(`${message.author}, ❓ Lütfen sadece **evet (e)** veya **hayır (h)** ile cevap verin.`)
    }
  ...
  if (uwu) {
    try {
      ...
      message.channel.send(`${message.author}, Kasa Açılıyor.`).then(async msg => {
        ...
        setTimeout(() => {
          msg.edit(`${message.author}, Kasa Açılıyor..`);
        }, 1000);
        setTimeout(() => {
          msg.edit(`${message.author}, Kasa Açılıyor...`);
        }, 2000);
        ...
        setTimeout(() => {
          msg.edit(`${message.author}, Kasa Açıldı!`);
          msg.delete()
        }, 5000);
        setTimeout(() => {
