...
app.get("/", (request, response) => {
  console.log("Lucifero pinglendi.");
...
client.ekoayarlar = {
  ...
  günlükpara: 70, //EĞER RASTGELE PARAYI TRUE YAPTIYSANIZ BURAYI ELLEMENİZE GEREK YOK!
  haftalıkpara:5000,
...
client.ekoayarlar2 = {
  ...
  isimsiz: "Bilinmiyor", //İSİMSİZ KİŞİLERİN HANGİ İSİM İLE GÖZÜKECEĞİNİ BELİRLEYEBİLİRSİNİZ!
  rastgelepara: true, //EĞER BUNU TRUE YAPARSANIZ RASTGELE PARA VERME ÖZELLİĞİ AKTİF OLUR VE GÜNLÜK PARALARI RASTGELE VERİR!
  minpara: 2000, //EĞER RASTGELE PARA DURUMUNU AKTİF ETTİYSENİZ BURADAN RASTGELE PARA PARAMETRESİNİNİN MİNUMUM PARASINI BELİRTİNİZ!
  maxpara: 4000, //EĞER RASTGELE PARA DURUMUNU AKTİF ETTİYSENİZ BURADAN RASTGELE PARA PARAMETRESİNİNİN MAXİMUM PARASINI BELİRTİNİZ!
  günlükpara: 70, //EĞER RASTGELE PARAYI TRUE YAPTIYSANIZ BURAYI ELLEMENİZE GEREK YOK!
  haftalıkpara:5000,
  dbloy: false, //EĞER BOTUNUZ DBL (DİSCORD BOT LİST) DE KAYITLIYSA GÜNLÜK ÖDÜL ALMAK İÇİN OY İSTER FALSE KAPALI, TRUE AKTİF DEMEK!
  dblkey: "KEY", //EĞER DBLOY U AKTİF ETMEDİYSENİZ BURAYA KEY EKLEMENİZE GEREK YOK EĞER AKTİF ETTİYSENİZ DBL SİTESİNDEN BULABİLİRSİNİZ!
...
client.on('message', async (message) => {
    if (message.content.startsWith('.yardım')) {
        ...
        .setStyle('url')
        .setLabel('YouTube')
        .setURL('https://www.youtube.com/c/SLayerT')
        
        let button2 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Davet Et')
        .setURL(`https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=27648860222`)
        
        let button3 = new disbut.MessageButton()
        .setStyle("url")
        .setLabel('Support') 
        .setURL('https://discord.gg/sS2ynffe3b')   
        
        let button4 = new disbut.MessageButton()
        .setStyle("url")
        .setLabel('Website') 
        .setURL('https://voidbotsite.glitch.me/index.html')   
        
/*const embed = new Discord.MessageEmbed()
      .setTitle(`Bir Rol Silindi!`) 
      .setColor(0x36393F)
      .addField(``);
    client.channels.cache.get(yardim4).send(embed);*/
        
        //embedli yardım mesajı yap
message.channel.send(`Merhaba ${message.author} **${client.user.username} Yardım Menüsüne Hoş Geldin** | Aşağıdan Seçim Yapabilirsin.
                         > • .kullanıcı: **Kullanıcı yardım menüsünü gösterir.**
                         > • .moderasyon: **Moderasyon yardım menüsünü gösterir.** 
                         > • .youtube: **Developer'ın YouTube kanalını gönderir.** 
                         > • .kayıt-sistemi: ** Kayıt sistemi yardım menüsünü gösterir.** 
                         > • .koruma-sistemi:** Koruma sistemi yardım menüsünü gösterir.** 
                         > • .logo-sistemi: ** Logo sistemi yardım menüsünü gösterir.**
                         > • .çekiliş-sistemi: ** Çekiliş sistemi yardım menüsünü gösterir.** 
                         > • .özeloda-sistemi: ** Özel Oda sistemi yardım menüsünü gösterir.** 
                         > • .profil-sistemi: **Profila sistemi yardım menüsünü gösterir.** 
                         > • .ekonomi-sistemi: ** Ekonomi sistemi yardım menüsünü gösterir.** 
                         > • .müzikyardım: ** Müzik Sistemini Gösteir!** 
                         > • .kısaltmalar: ** Komut Kısaltmalarını Gösterir!**`, {
  buttons:[
...
client.on('clickButton', async (button, message) => {
  if (button.id === 'buton1()') {
    ...
    if (button.id === 'buton2') {
      button.channel.send(`https://discord.gg/sS2ynffe3b`)
  }
  /*
    const AsreaperEmbed = new AsreaperDiscord.MessageEmbed();
  AsreaperEmbed.setColor(0x36393F)
  AsreaperEmbed.setDescription(` Lucifero'yu davet etmek için [buraya](https://discord.com/api/oauth2/authorize?client_id=907344275765874708&permissions=8&scope=bot) tıkla!`)
  ...
  */
  ...
  /*if (button.id === 'buton3()') {
      button.channel.send(`||https://www.youtube.com/c/SpikeT||`)
  }*/
});
...
return message.channel.send(`**${message.author}, <@571327787856822295>'ın Botuna Hoş Geldin | Aşağıdan Kanala Ulaşabilirsin.**`, {
  buttons:[
                button,
...
return message.channel.send(`**${message.author}, Aşağıdan Siteye Ulaşabilirsin | Site linki: https://voidbotsite.glitch.me/**`, {
  buttons:[
                button,
...
client.on('message', async (message) => {
    if (message.content.startsWith('.site')) {        
        ...
        .setStyle('url')
        .setLabel('Website')
        .setURL('https://voidbotsite.glitch.me/')
...
client.on('message', async (message) => {
    if (message.content.startsWith('Lyardım'))
        
return message.channel.send(`**Merhaba ${message.author}, sanırım sana nasıl yardım edebileceğimi biliyorum __komutlar__ yazarsan komutlarıma ulaşabilirsin.**`, );
});
...
return message.channel.send(`**${message.author}, işte komutlar.**
                         > • .kullanıcı: **Kullanıcı yardım menüsünü gösterir.**
                         > • .moderasyon: **Moderasyon yardım menüsünü gösterir.** 
                         > • .youtube: **Developer'ın YouTube kanalını gönderir.** 
                         > • .kayıt-sistemi: ** Kayıt sistemi yardım menüsünü gösterir.** 
...
client.on("guildMemberAdd", member => {
  ...
  let akanal = db.fetch(`abonekanal_${member.guild.id}`);
  let kanal = db.fetch(`kayıthg_${member.guild.id}`);
  let bkanal = db.fetch(`botkayıthg_${member.guild.id}`);
  let bkayıtçı = db.fetch(`botkayıtçırol_${member.guild.id}`);
...
client.on('message', async message => {
  ...
  return message.channel.send(" Bu Kodu `Yönetici` Yetkisi Olan Kişi Kullanabilir.");
    message.channel.send(`Özel Oda Sisteminin Kurulmasını İstiyorsanız **Kur** Yazınız.`)
      message.channel.awaitMessages(response => response.content === 'kur','Kur','KUR', {
        max: 1,
        time: 10000,
        errors: ['time'],
     })
...
message.guild.channels.create('【🔐】2 Kişilik Odalar【🔐】', 'Özel Oda', [{
  id: message.guild.id,
}]);
...
message.guild.channels.create('【🔐】3 Kişilik Odalar【🔐】', 'Özel Oda', [{
  id: message.guild.id,
}]);
...
message.guild.channels.create('【🔐】4 Kişilik Odalar【🔐】', 'Özel Oda', [{
  id: message.guild.id,
}]);
...
message.guild.channels.create('【🔐】5 Kişilik Odalar【🔐】', 'Özel Oda', [{
  id: message.guild.id,
}]);
...
client.on('guildCreate', guild => {
    ...
    asreaper1.send("**Lucifero Botunu Sunucuya Eklediğiniz İçin Teşekkürler!** \n .yardım Yazarak Yardım Menüsüne Erişebilirsiniz!");

});
client.on("guildCreate", async guild => {
  const asreaper2 = [
    "Botumuzu Sunucuna Eklediğin İçin Teşekkürler!",
    "Bu Bot Castro Tarafından Geliştirilmiştir!",
...
////////////Ücretsiz Oyun Sistemi///

client.on('message', async (message) => {
    if (message.content.startsWith(`ütoyardım`)) {   
...
return message.channel.send(`**Merhaba ${message.author}, Ücretsiz Oyun Sistemi'ne hoşgeldin. Ücretsiz oyun linklerine ulaşmak için "üto (oyun ismi birleşik)" şeklinde yazarsanız linklere ulaşabilirsiniz.**
Not: Şu anlık bu komutu sadece Lucifero'nun sahibi kullanabilir!`, {
  buttons:[]
        });
    };
});
...
client.on('message', async (message) => {
    if (message.content.startsWith(`üto gtasan`)) {  
      if(!client.ekoayarlar.admin.includes(message.author.id)) return message.reply(`Bu komutu sadece <@571327787856822295> kullanabilir!`)
        let button = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('MediaFire')
        .setURL('https://www.mediafire.com/folder/ns1fm5ymqd26r/MENZİL')
        let button2 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('GoogleDrive')
        .setURL('https://drive.google.com/drive/folders/1RuiX009MVbRKzQTl2MGf5hKvuKak0UNt')
        let button3 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('dosya.co')
        .setURL('https://dosya.co/th7y83q5kxgj/GTA_SA_500MB.rar.html')
        
return message.channel.send(`**İşte Oyun Linkin ${message.author}, İyi Oyunlar Dilerim.**`, {
  buttons:[
...
client.on('message', async (message) => {
    if (message.content.startsWith(`üto mc`)) {        
      if(!client.ekoayarlar.admin.includes(message.author.id)) return message.reply(`Bu komutu sadece <@571327787856822295> kullanabilir!`)
        let button = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Windows')
        .setURL('https://tlauncher.org/installer')
        let button2 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Mac')
        .setURL('https://tlauncher.org/jar')                                   
        let button3 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Linux')
        .setURL('https://tlauncher.org/jar')
...
//////////Ücretsiz Oyun Sistemi Son///////

client.on('message', async (message) => {
    if (message.content.startsWith(`rtürkiye`)) {
        let button = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Atatürk')
        .setURL('https://humanova.github.io/rplace-turkey/ataturk')
        let button2 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Bayrak')
        .setURL('https://humanova.github.io/rplace-turkey/elraenn_bayrak')                                   

message.delete()

return message.channel.send(`**Reddit Türkiye Savunma!**
